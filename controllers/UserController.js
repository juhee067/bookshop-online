...
const signup = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({ message: '회원가입 중에 오류가 발생했습니다.' });
  }
};
...
const signin = async (req, res) => {
  try {
    ...
    res
      ...
      .json({ message: '로그인 중에 오류가 발생했습니다.' });
  }
};
  ...
  try {
    ...
    if (!user) {
      return res
        ...
        .json({ status: 404, msg: '회원이 존재하지 않습니다.' });
    }
...
const updateUserInfo = async (req, res) => {
  try {
    ...
    res
      .status(StatusCodes.OK)
      .json({ status: 200, msg: '회원정보가 수정되었습니다' });
  } catch (err) {
    res
      .status(StatusCodes.INTERNAL_SERVER_ERROR)
      .json({ msg: '회원 수정 중에 문제가 발생했습니다.' });
  }
};
...
const deleteUserAccount = async (req, res) => {
  try {
    ...
    res
      .status(StatusCodes.OK)
      .json({ status: 200, msg: '회원이 삭제되었습니다.' });
  } catch (err) {
    res
      .status(StatusCodes.INTERNAL_SERVER_ERROR)
      .json({ msg: '회원 삭제 중에 문제가 발생했습니다.' });
  }
};
