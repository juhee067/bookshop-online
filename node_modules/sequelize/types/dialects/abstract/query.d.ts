import { Connection } from 'sequelize/lib/dialects/abstract/connection-managerts/abstract/connection-manager';
import { Model, ModelType, IncludeOptions } from 'sequelize/lib/modelib/model';
import { Sequelize } from 'sequelize/lib/sequelizeequelize';
