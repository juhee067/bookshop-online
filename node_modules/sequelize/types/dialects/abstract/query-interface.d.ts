...
import {
  ...
  CreationAttributes,
  Attributes
} from 'sequelize/lib/modelib/model';
import QueryTypes = require('sequelize/lib/query-typesry-types');
import { Sequelize, RetryOptions } from 'sequelize/lib/sequelizeequelize';
import { Transaction } from 'sequelize/lib/transactionnsaction';
import { SetRequired } from 'sequelize/lib/utils/set-requiredrequired';
import { Fn, Literal } from 'sequelize/lib/utilsib/utils';
import { Deferrable } from 'sequelize/lib/deferrableferrable';
