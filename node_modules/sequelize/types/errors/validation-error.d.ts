import type { Model } from 'sequelizequelize';
import type { ErrorOptions } from 'sequelize/lib/errors/base-errorb/errors/base-error';
import BaseError from 'sequelize/lib/errors/base-errorb/errors/base-error';
/**
