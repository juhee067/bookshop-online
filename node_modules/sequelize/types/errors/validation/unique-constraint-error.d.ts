import { CommonErrorProperties, ErrorOptions } from 'sequelize/lib/errors/base-error/errors/base-error';
import ValidationError, { ValidationErrorItem } from 'sequelize/lib/errors/validation-errors/validation-error';
